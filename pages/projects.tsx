...
import { ProjectInterface, ResponseData } from '../lib/types';

interface Props {
	data: (ProjectInterface & { _id: string })[];
}
			...
			<div className="container">
				...
				{!data && (
					<div className="mt-10">
						<svg
							role="status"
							className="inline ml-8 w-16 h-16 text-gray-200 animate-spin dark:text-gray-400 fill-purple-600"
							viewBox="0 0 100 101"
							fill="none"
						...
						<h1 className="animate-pulse text-3xl font-bold">Loading...</h1>
					</div>
				)}
				{data.map((project, i) => {
					return (
