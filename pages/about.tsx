		...
		>
			<div className="container">
				...
				<h2 className="font-semibold mt-5 mb-5 w-72 text-3xl">
					I am interested in web development, networking and systems. I like
					helping other programmers and contributing to open source projects.
				</h2>
				<h1 className="font-bold text-5xl">
					<span className="h-text">Technologies </span> I use
				</h1>
				<h2 className="font-semibold mt-5 mb-5 w-96 text-3xl">
					Typescript, C, Lua, MongoDB, ExpressJS, TailwindCss, Figma.
				</h2>
			</div>
		</Layout>
	);
